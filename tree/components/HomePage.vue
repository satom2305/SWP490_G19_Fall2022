          ...
          <div class="featured__item">
            <div class="featured__item__pic set-bg" data-setbg="img/featured/feature-1.jpg">
              <ul class="featured__item__pic__hover">
                <li><a href="#"><font-awesome-icon icon="fa fa-heart"/></a></li>
                <li><a href="#"><font-awesome-icon icon="fa fa-retweet"/></a></li>
                <li><a href="#"><font-awesome-icon icon="fa fa-shopping-cart"/></a></li>
              </ul>
            </div>
        ...
        <div class="col-lg-12">
          <div class="footer__copyright">
            <div class="footer__copyright__text"><p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <font-awesome-icon icon="fa fa-heart" aria-hidden="true"/> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
